            ...
            <div class="row">
                <div class="product-view">
                        ...
                        <form action="#" method="post" id="product_addtocart_form">
                            ...
                            <div class="product-img-box col-sm-4 col-xs-12">
                                ...
                                <div class="product-image">
                                    <div class="large-image"> <a href="{{ asset('uploads/products-images/product4.jpg') }}" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img alt="product-image" src="{{ asset('uploads/products-images/product4.jpg') }}"> </a> </div>
                                    <div class="flexslider flexslider-thumb">
                                        <ul class="previews-list slides">
                                            <li><a href="{{ asset('uploads/products-images/product6.jpg')}} " class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product6.jpg' "><img src="{{ asset('uploads/products-images/product6.jpg') }} " alt="Thumbnail 1"/></a></li>
                                            <li><a href="{{ asset('uploads/products-images/product10.jpg')}} " class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product10.jpg' "><img src="{{ asset('uploads/products-images/product10.jpg') }}" alt="Thumbnail 2"/></a></li>
                                            <li><a href="{{ asset('uploads/products-images/product3.jpg')}} " class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product3.jpg' "><img src="{{ asset('uploads/products-images/product3.jpg') }}" alt="Thumbnail 1"/></a></li>
                                            <li><a href="{{ asset('uploads/products-images/product4.jpg')}} " class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product4.jpg' "><img src="{{ asset('uploads/products-images/product4.jpg') }}" alt="Thumbnail 2"/></a></li>
                                            <li><a href="{{ asset('uploads/products-images/product5.jpg')}} " class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/product5.jpg' "><img src="{{ asset('uploads/products-images/product5.jpg') }}" alt="Thumbnail 2"/></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- end: more-images -->
                            ...
                            <div class="product-img-box col-sm-3 col-xs-12">
                                <div class="product-additional"> <img alt="custom block" src="{{ asset('uploads/offer-banner/offer-banner3.png') }}"> </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        @include('frontend.product.related-pro')
                        @include('frontend.product.upsell-pro')
                        </div>
                    </div>
                </div>
            </div>

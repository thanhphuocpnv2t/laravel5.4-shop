        ...
        <div class="nav-inner">
            ...
            <ul id="nav" class="hidden-xs">
                ...
                <li class="level0 nav-5 level-top first"> <a href="grid.html" class="level-top"> <span>Women</span> <span class="category-label-hot">Hot</span></a>
                    <div style="display: none; left: 0px;" class="level0-wrapper dropdown-6col">
                        ...
                        <div class="nav-add">
                            <div class="push_item">
                                <div class="push_img"> <a href="#"> <img alt="women_jwellery" src="{{ asset('uploads/products-images/women_jwellery.png') }}"> </a> </div>
                                <div class="push_text">Lorem Ipsum is simply dummy text of the printing</div>
                            </div>
                            <div class="push_item">
                                <div class="push_img"> <a href="#"> <img alt="women_bag" src="{{ asset('uploads/products-images/women_bag.png') }}"> </a> </div>
                                <div class="push_text">Lorem Ipsum is simply dummy text of the printing</div>
                            </div>
                            <div class="push_item">
                                <div class="push_img"> <a href="#"> <img alt="women_sandle" src="{{ asset('uploads/products-images/women_sandle.png') }}"> </a> </div>
                                <div class="push_text">Lorem Ipsum is simply dummy text of the printing</div>
                            </div>
                            <div class="push_item push_item_last">
                                <div class="push_img"> <a href="#"> <img alt="women_top" src="{{ asset('uploads/products-images/women_top.png') }}"> </a> </div>
                                <div class="push_text">Lorem Ipsum is simply dummy text of the printing</div>
                            </div>
                            <br class="clear">
                        </div>
                ...
                <li class="level0 nav-6 level-top parent"> <a href="grid.html" class="level-top"> <span>Electronics</span> <span class="category-label">New</span></a>
                    <div style="display: none; left: 0px;" class="level0-wrapper dropdown-6col">
                        <div class="level0-wrapper2">
                            ...
                            <div class="nav-block nav-block-right std grid12-3"> <a class="product-image" title="Stablished fact reader" href="#"> <img alt="Product image" src="{{ asset('uploads/products-images/product1.jpg') }}" width="150"></a>
                ...
                <li class="level0 nav-7 level-top parent"> <a class="level-top" href="grid.html"> <span>Furniture</span> </a>
                    <div class="level0-wrapper dropdown-6col" style="left: 0pt; display: none;">
                        <div class="level0-wrapper2">
                            ...
                            <div class="nav-block nav-block-right std grid12-4"><a href="grid.html"><img src="{{ asset('uploads/products-images/menu_furniture.png') }}" alt="menu_furniture" class="fade-on-hover"></a> </div>
                        </div>
                    </div>
                </li>
            ...
            <div id="form-search" class="search-bar">
                <form id="search_mini_form" action="#" method="get">
                    ...
                    <span class="search-icon"><img src="{{ asset(config('app.frontend_themes').'/images/search-icon.png') }}" alt="search-icon"></span>
                </form>
            </div>
        </div>
    </div>

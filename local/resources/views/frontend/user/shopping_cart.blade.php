                    ...
                    <form method="post" action="#updatePost/">
                        ...
                        <fieldset>
                            <table class="data-table cart-table" id="shopping-cart-table">
                                ...
                                <tbody>
                                <tr class="first odd">
                                    <td class="image"><a class="product-image" title="Sample Product" href="product_detail.html"><img width="75" alt="Sample Product" src="{{ asset('uploads/products-images/product3.jpg') }}"></a></td>
                                ...
                                <tr class="last even">
                                    <td class="image"><a class="product-image" title="Sample Product" href="product_detail.html"><img width="75" alt="Sample Product" src="{{ asset('uploads/products-images/product4.jpg') }}"></a></td>
                                    <td><h2 class="product-name"> <a href="product_detail.html">Sample Product</a> </h2></td>

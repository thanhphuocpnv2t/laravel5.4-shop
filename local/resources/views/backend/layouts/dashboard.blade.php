...
<head>
    ...
    <title>LOCK SCREEN | BLANKON - Fullpack Admin Theme</title>
    <!--/ END META SECTION -->
    ...
    <link href="{{ asset(config('app.backend_themes').'/assets/admin/css/pages/sign.css') }}" rel="stylesheet">
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset(config('app.backend_themes').'/assets/global/plugins/bower_components/html5shiv/dist/html5shiv.min.js') }}"></script>
    <script src="{{ asset(config('app.backend_themes').'/assets/global/plugins/bower_components/respond-minmax/dest/respond.min.js') }}"></script>
    <![endif]-->
    <!--/ END IE SUPPORT -->
</head>
<!--/ END HEAD -->
...
<script src="{{ asset(config('app.backend_themes').'/assets/admin/js/pages/blankon.sign.js') }}"></script>
